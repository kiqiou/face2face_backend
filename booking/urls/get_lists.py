...
from booking.views.get_lists import (
    get_cosmetologist_by_id, get_cosmetologist_by_user_id, get_free_intervals, list_all_bookings, list_all_work_days, list_categories, list_cosmetologist_bookings, list_cosmetologists, list_procedures,
...
urlpatterns = [
    ...
    path('get_categories/', list_categories,),
